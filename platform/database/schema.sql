...
-- Member Messages (secure messaging between members and staff)
...
-- Applications (member-submitted loan/service applications)
...
-- Loan type reference codes (editable code -> description, like the old core system)
...
-- Seed loan type codes A-O for the default tenant
